...
import profilePic from "../assets/Screenshot (623).png";
    ...
    <div className="flex flex-wrap">
        ...
        <div className="flex flex-col item-center lg:items-start">
            ...
            <motion.span 
             ...
             initial="hidden"
             animate="visible"
             className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-4xl tracking-light text-transparent">Web Developer</motion.span>
            <motion.p 
